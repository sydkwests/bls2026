    ...
    <>
      ...
      <div className="bg-slate-900 py-24 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
            ...
            <Link to="/sponsorship" className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-full font-bold hover:bg-blue-500 transition-colors shadow-lg shadow-blue-600/30">
                View Waitlist Options <ArrowRight />
            </Link>
        </div>
      </div>
    </>
