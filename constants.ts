...
export const COMPETITIONS_LIST = [
  {
    ...
    description: 'A national-level case study competition where student teams solve real-world corporate sustainability and business problems.',
    icon: Trophy,
    color: 'bg-orange-500'
  },
  {
...
export const LEADERSHIP_MESSAGES = [
  ...
  },
  {
    ...
    role: "Professor and Dean of FMC, RUAS",
...
export const COMMITTEES = {
  executive: [
    { name: 'Prof. Kuldeep Kumar Raina', image: "/images/leadership/kuldeep-raina.jpg", role: 'Patron', designation: 'Honourable Vice-Chancellor of RUAS', linkedin: "https://www.linkedin.com/in/dr-kuldeep-raina-b4207524" },
    { name: 'Dr. Sharath Kumar K. M.', image: "/images/leadership/sharath-kumar.jpg", role: 'Chief Advisor', designation: 'Professor and Dean of FMC, RUAS', linkedin: "https://www.linkedin.com/in/dr-k-m-sharath-kumar-ph-d-80400714" },
    { name: 'Dr. Subhadeep Mukherjee', image: "/images/leadership/subhadeep-mukherjee.jpg", role: 'Centre Head', designation: 'Associate Professor at FMC, RUAS', linkedin: "https://www.linkedin.com/in/dr-subhadeep-mukherjee-aa78a182" },
    { name: 'Mr. Ajay R', image: "/images/committee/ajay-r.jpg", role: 'Finance Head and Auditor', designation: 'Assistant Professor at FMC, RUAS', linkedin: "https://www.linkedin.com/in/ajay-r-50b467270" },
    { name: 'Dr. Kiran Kumar B M', image: "/images/committee/kiran-kumar.jpg", role: 'Head Event & Campus Coordination', designation: 'Associate Professor at FET, RUAS', linkedin: "https://www.linkedin.com/in/dr-kiran-kumar-b-m-17539769" },
    { name: 'Dr. Pallabi Mund', image: "/images/committee/pallabi-mund.jpg", role: 'Head Event & Campus Coordination', designation: 'Associate Professor at FMC, RUAS', linkedin: "https://www.linkedin.com/in/dr-pallabi-mund-53163a20" },
    { name: 'Ms. Sujata Bijwe', image: "/images/committee/sujata-bijwe.jpg", role: 'Head Industry Connect', designation: 'Adjunct Faculty at FMC, RUAS', linkedin: null }
  ],
  core: [
...
export const SPONSORSHIP_MATRIX = {
  corporate: {
    ...
    features: [
      { name: "Title Association", values: [false, false, true] },
      { name: "Banners", values: [true, true, true] },
      { name: "Online Ads Sharing", values: [true, true, true] },
      { name: "Event Promotions", values: [true, true, true] },
      { name: "Posters", values: [true, true, true] },
      { name: "Video at Inauguration", values: [false, false, true] },
      { name: "Mention during Inauguration", values: [true, false, true] },
      { name: "Video/Intro during Events", values: [false, true, true] },
      { name: "Conclave Podium", values: [true, true, true] },
      { name: "LED Screen Display", values: [true, true, true] },
      { name: "Conclave Dinner Invitation", values: [true, true, true] },
      { name: "Panel Discussion/ Speaker", values: [false, true, true] },
      { name: "Special Recognition (Momento)", values: [false, true, true] },
      { name: "Stalls", values: [false, true, true] }
    ]
  },
  educational: {
