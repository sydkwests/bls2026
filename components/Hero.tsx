...
const Hero: React.FC = () => {
  ...
  return (
    ...
    <header id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white pt-28 md:pt-32 pb-20">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-0 w-96 h-96 bg-cyan-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
            ...
            <motion.div
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-slate-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] mb-4"
            >
                <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                <span className="text-slate-600 text-xs font-bold tracking-widest uppercase">LEADS NEXT GEN CENTRE | RUAS</span>
            </motion.div>
            ...
            >
                <Link to="/events" className="cursor-pointer group">
                    <div className="relative inline-flex items-center gap-2 px-5 py-2 rounded-full border border-emerald-200/60 shadow-lg shadow-emerald-500/10 bg-[linear-gradient(110deg,#ecfdf5,45%,#ffffff,55%,#ecfdf5)] bg-[length:200%_100%] animate-shimmer overflow-hidden transition-transform group-hover:scale-105">
            ...
            <motion.h1
                ...
                className="text-5xl sm:text-6xl md:text-7xl lg:text-[6rem] font-black tracking-tight text-slate-900 mb-6 leading-[0.95]"
            >
            ...
            <motion.p
                ...
                className="text-lg md:text-xl text-slate-600 mb-10 font-light leading-relaxed max-w-2xl mx-auto"
            >
