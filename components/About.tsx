                            ...
                            {activeTab === 'centre' ? (
                                ...
                                >
                                    ...
                                    <p className="text-slate-600 text-lg leading-relaxed">
                                        The Centre for Leadership Empowering Attitude Development for Sustainability (L.E.A.D.S) is a premier, student-led initiative at RUAS, strategically evolved from the E-Cell to foster multidisciplinary leadership and a sustainability mindset. 
                                    </p>
                                    <p className="text-slate-600 text-lg leading-relaxed">
                    ...
                    <div className="relative aspect-square md:aspect-[4/3] lg:aspect-square">
                        ...
                        <div className="grid grid-cols-2 gap-4 h-full relative z-10 p-4">
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-slate-500 text-sm leading-relaxed max-w-sm">
                                        Uniting changemakers where business success and planetary stewardship become inseparable.
                                    </p>
                                </div>
                                {/* Tech Scanline */}
                            ...
                            >
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-slate-900 mb-1">Mission</h3>
                                    <p className="text-slate-500 text-xs font-medium">Equipping leaders with futuristic mindsets.</p>
                                </div>
                            </motion.div>
