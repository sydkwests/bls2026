    ...
    <footer id="contact" className="bg-[#0f172a] pt-20 pb-10 relative overflow-hidden text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div>
                    ...
                    <div className="flex items-start gap-3 text-slate-400 text-sm group">
                        ...
                        <p className="mt-1 leading-relaxed">
                            University House,<br />
                            Gnanagangothri Campus,<br />
                            New BEL Road, M S Ramaiah Nagar,<br />
            ...
            <div className="w-full h-64 rounded-2xl overflow-hidden mb-12 border border-slate-800 shadow-2xl relative group">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.3567676941164!2d77.56499831482245!3d13.012959990828796!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17d917955555%3A0x6b19a2283e58c8a1!2sRamaiah%20University%20of%20Applied%20Sciences!5e0!3m2!1sen!2sin!4v1677651234567!5m2!1sen!2sin" 
                    width="100%" 
                    height="100%" 
                    style={{ border: 0, filter: 'grayscale(1) contrast(1.2)', pointerEvents: mapActive ? 'auto' : 'none' }} 
                    allowFullScreen 
                    loading="lazy" 
